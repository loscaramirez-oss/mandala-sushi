...
let cart = JSON.parse(localStorage.getItem("mandalaCart") || "[]");
...
let cycle = parseInt(localStorage.getItem("mandalaCycle") || "0", 10);
const oldVisits = parseInt(localStorage.getItem("mandalaVisits") || "0", 10);
if (oldVisits > 0 && !localStorage.getItem("mandalaCycle")) {
  cycle = oldVisits % 8;
  localStorage.setItem("mandalaCycle", String(cycle));
  localStorage.removeItem("mandalaVisits");
}
localStorage.removeItem("mandalaTotal");
...
function save() { localStorage.setItem("mandalaCart", JSON.stringify(cart)); }
