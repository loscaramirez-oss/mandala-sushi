  ...
  class DrawerView {
    constructor(deps) {
      ...
      this.hooks = {
        ...
        onRemove: null,  // (key)
        onClear: null,
        onRepeat: null   // reordenar último pedido
      };
    }
    ...
    renderDrawer(body, total, foot, clearBtn) {
      ...
      if (!this.cart.items.length) {
        ...
        if (this.cart.hasLast) {
          const rep = document.createElement("button");
          rep.type = "button";
          rep.className = "repeat-btn";
          rep.textContent = "🔄 Repetir mi último pedido";
          rep.onclick = () => this.hooks.onRepeat && this.hooks.onRepeat();
